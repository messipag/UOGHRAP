                                ...
                                <div class="card card-primary card-outline">
                                    <div class="card-header">
                                        ...
                                        <span class="float-right">
                                            <a class="btn btn-primary btn-sm" href="{{ route('ranks.create') }}">
                                                <i class="fas fa-medal"></i> New Rank</a>
                                        </span>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <a class="btn btn-primary  btn-sm mr-1 mb-0"
                                                                    href="{{ route('ranks.edit', $rank->id) }}"><i
                                                                        class="fas fa-edit"></i></a>

                                                                <a class="btn btn-success  btn-sm mr-1 mb-0"
                                                                    href="{{ route('ranks.show', $rank->id) }}"><i
                                                                        class="fas fa-eye"></i></a>

                                                                <form action="{{ route('ranks.destroy', $rank->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
