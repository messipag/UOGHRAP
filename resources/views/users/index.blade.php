...
@can('user-list')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><i class="fas fa-user-tag"></i> Users</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                    ...
                    <span class="float-right">
                        ...
                        @can('user-create')
                                <a class="btn btn-primary btn-sm" href="{{ route('users.create') }}">
                                    <i class="fas fa-user-tag"></i> New User</a> 
                        @endcan
                    </span>
              </div>
              <!-- /.card-header -->
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <div class="btn-group">
                                ...
                                @can('user-edit')
                                    <a class="btn btn-primary  btn-sm mr-1 mb-0" href="{{ route('users.edit',$user->id) }}"><i class="fas fa-edit"></i></a>
                                @endcan
                                @can('user-show')
                                  <a class="btn btn-success  btn-sm mr-1 mb-0" href="{{ route('users.show',$user->id) }}"><i class="fas fa-eye"></i></a>
                                @endcan
                                @can('user-delete')
